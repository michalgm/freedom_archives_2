      ...
      <DialogContent dividers>
        ...
        >
          <dl>
            ...
            <dd>
              You can always type what you’re looking for into the search bar. Certain searches may generate hundreds of results, so sometimes it will help to use quotation marks to help narrow down your results. For instance, searching for the phrase
              {' '}
              <code>Black Liberation</code>
              {' '}
              will generate all of our holdings that contain the words Black
              {' '}
              <b>and</b>
              {' '}
              Liberation, while searching for
              {' '}
              <code>"Black Liberation"</code>
              {' '}
              (in quotation marks) will only generate our records that have those two words next to each other.
            </dd>
            <dt>Advanced Searching</dt>
            <dd>
              The Freedom Archives search site also understands Boolean search logic, specifically AND (
              <code>+</code>
              ,
              {' '}
              <code>&amp;</code>
              ...
              {' '}
              <Link target="_blank" href="http://libguides.mit.edu/c.php?g=175963&p=1158594">Here is a brief tutorial on how to use Boolean search logic </Link>
            ...
            <dt>Word Stemming</dt>
            <dd>
              The Freedom Archives search function performs "word-stemming” to match words related to your search terms. For example, a search for
              {' '}
              ...
              ,
              {' '}
              <code>liberating</code>
              ,
              {' '}
              <code>liberations</code>
              , etc.
            </dd>
