...
DROP TABLE IF EXISTS collections_snapshots CASCADE;
...
DROP TABLE IF EXISTS featured_records_snapshots CASCADE;
...
DROP TABLE IF EXISTS list_items_snapshots CASCADE;
CREATE TABLE
...
DROP TABLE IF EXISTS records_to_list_items_snapshots CASCADE;
CREATE TABLE
