...
DROP TABLE IF EXISTS collections_snapshots;
...
DROP TABLE IF EXISTS featured_records_snapshots;
...
DROP TABLE IF EXISTS public_search.list_items;
...
DROP TABLE IF EXISTS list_items_snapshots;
...
DROP TABLE IF EXISTS records_to_list_items_snapshots;
